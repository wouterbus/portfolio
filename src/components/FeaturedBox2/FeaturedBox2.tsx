...
export default function FeaturedBox2({ onProjectClick }: FeaturedBox2Props) {
  ...
  // Determine media to display: prefer video, then image thumbnail, then heroBanner
